...
#SBATCH -e slurm-serve-ghz_state_timing%j.err
#SBATCH -o slurm-serve-ghz_state_timing%j.out
### GPU options ###
...
srun python NCSA_sample__GHZ_state_python_script_cpu_gpu_average_timing.py