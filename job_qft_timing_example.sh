...
#SBATCH -e slurm-serve-qft_timing_example%j.err
#SBATCH -o slurm-serve-qft_timing_example%j.out
### GPU options ###
...
srun python NCSA_sample_QFT_python_script_cpu_gpu_average_timing.py